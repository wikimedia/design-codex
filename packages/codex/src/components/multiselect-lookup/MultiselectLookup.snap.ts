  ...
  >
    ...
    >
      ...
      <div
        ...
        class="cdx-input-chip cdx-chip-input__item"
        role="option"
        tabindex="0"
      >
        <!--v-if-->
        ...
        <button
          aria-hidden="true"
          class="cdx-button cdx-button--action-default cdx-button--weight-quiet cdx-button--size-medium cdx-button--icon-only cdx-input-chip__button"
          tabindex="-1"
        >
          <!-- @slot Button content -->
