...
describe( 'Dialog', () => {
	...
	const dialogWithCloseButtonLabelOpen = Object.freeze( { props: { title: 'Dialog Title', open: true, useCloseButton: true, closeButtonLabel: 'Close button label from prop' }, slots: { default: dialogSlotContents } } );
